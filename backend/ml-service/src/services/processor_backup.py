    ...
    async def process_chunk(self, chunk_path: str, chunk_metadata: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            for frame_idx, frame in enumerate(frames):
                ...
                # TEMPORARILY DISABLED: Pose processing to isolate detection results
                frame_poses = []
                # TODO: Re-enable pose processing after fixing array indexing issues
                # Skip complex pose processing for now - just save horses to database
