...
- [ ] Find current video serving endpoint
- [ ] Modify to check ml_processed flag
- [ ] If ml_processed=true, serve processed_video_path
- [ ] Else serve raw_video_path
...
1. **Two separate video systems exist**:
   - Live HLS streaming (video-streamer → HLS.js)
   - Recorded chunks (FFmpeg recording → direct MP4 playback)
